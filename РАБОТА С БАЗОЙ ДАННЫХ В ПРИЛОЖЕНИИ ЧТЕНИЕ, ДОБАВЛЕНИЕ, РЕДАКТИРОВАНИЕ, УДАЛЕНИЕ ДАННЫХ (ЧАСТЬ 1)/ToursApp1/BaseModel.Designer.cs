// Создание кода T4 для модели "\\192.168.1.1\студенты\185\Фоменко\Жирнова\WordSkills\СОЗДАНИЕ КАРКАСА ПРИЛОЖЕНИЯ. СОЗДАНИЕ И ИСПОЛЬЗОВАНИЕ СТИЛЕЙ\ToursApp1\BaseModel.edmx" включено. 
