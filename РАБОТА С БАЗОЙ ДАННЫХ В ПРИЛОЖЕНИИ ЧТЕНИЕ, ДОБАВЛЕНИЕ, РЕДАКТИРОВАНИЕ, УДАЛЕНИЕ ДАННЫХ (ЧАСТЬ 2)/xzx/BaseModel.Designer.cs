// Создание кода T4 для модели "\\192.168.1.1\студенты\185\Фоменко\Жирнова\WordSkills\РАБОТА С БАЗОЙ ДАННЫХ В ПРИЛОЖЕНИИ ЧТЕНИЕ, ДОБАВЛЕНИЕ, РЕДАКТИРОВАНИЕ, УДАЛЕНИЕ ДАННЫХ (ЧАСТЬ 2)\xzx\BaseModel.edmx" включено. 
